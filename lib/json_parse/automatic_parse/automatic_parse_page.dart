...
import 'package:flutter101/json_parse/automatic_parse/automatic_parse_model.dart';

import '../json_parse_service.dart';
import '../json_structure.dart';

class AutomaticParsePage extends StatefulWidget {
  @override
  _AutomaticParsePageState createState() => _AutomaticParsePageState();
}

class _AutomaticParsePageState extends State<AutomaticParsePage> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(title: Text('Automatic Parse')),
      body: Container(
              ...
              if (snapshot.connectionState == ConnectionState.done && snapshot.hasData) {
                ...
                switch (_jsonStructure) {
                  case JsonStructure.basicList:
                    return Text(BasicList.fromJson(decodedJson).students.toString());
